    ...
    <div className="min-h-screen flex w-full bg-slate-50">
      <div className="flex-1 flex flex-col justify-center items-center p-8 sm:p-12 lg:p-24 relative z-10">
        ...
        <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-3xl shadow-xl border border-slate-100">
          <div className="text-center space-y-2">
            ...
            <p className="text-slate-500">Sign in to order your favorite snacks</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6 mt-8">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <button type="button" onClick={handlePasswordReset} disabled={resetLoading} className="text-xs font-medium text-orange-600 hover:text-orange-700 hover:underline">
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            Don't have an account? <Link href="/signup" className="text-orange-600 hover:underline font-medium">Sign up</Link>
          </p>
        </div>
      </div>
      ...
      <div className="hidden lg:flex flex-1 relative bg-slate-900 overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-end p-24 text-white w-full h-full">
          <h2 className="text-5xl font-bold mb-4 drop-shadow-md">Craving Something Crispy?</h2>
          <p className="text-xl text-orange-100 font-medium drop-shadow max-w-lg leading-relaxed">
            Order delicious, homemade snacks directly to your doorstep.
          </p>
        </div>
      </div>
    </div>
